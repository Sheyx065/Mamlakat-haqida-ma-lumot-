document.addEventListener("DOMContentLoaded", function () {
  ...
  fetch("https://date.nager.at/api/v3/AvailableCountries")
    ...
    .catch((error) => console.error("Mamlakatlarni olishda xatolik yuz berdi:", error));
  ...
  getCountryInfoButton.addEventListener("click", () => {
    ...
    if (countryCode) {
      fetch(`https://date.nager.at/api/v3/CountryInfo/${countryCode}`)
        ...
        .catch((error) => console.error("Mamlakat malumotlarini olishda xatolik yuz berdi:", error));
    } else {
